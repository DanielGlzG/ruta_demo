...
abstract class CombinedRepository {
  Future<void> synchAll();

  Future<List<Articulo>> syncArticulos();

  Future<List<Almacen>> syncAlmacenes();

  Future<List<Cliente>> syncClientes();

  Future<List<Cobrador>> syncCobradores();
  Future<List<Moneda>> syncMonedas();

  Future<List<Sucursal>> syncSucursales();
  Future<List<Vendedor>> syncVendedores();

  Future<List<CondicionPago>> syncCondicionesPago();
